...
Fabric network you created in [Part 1](../tandt-fabric/README.md)

All steps are carried out on the Fabric client node you created in [Part 1](../tandt-fabric/README.md)
...
cp ./trackandtrace/tandt-chaincode/src/* ./fabric-samples/chaincode/ngo
```
