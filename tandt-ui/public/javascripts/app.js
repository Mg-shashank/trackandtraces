...
import supplyChain_artifacts from '../../build/contracts/SupplyChainV1.json'
...
window.addEventListener('load', function() { 
  ...
  //Prod Env
  //web3Instance = new Web3(new Web3.providers.HttpProvider("http://bclryl-dns-reg1.centralus.cloudapp.azure.com:8545"));
...
setMarkerByType :function Markers(type) {
  ...
  if(type == "Prd" )
    urltype = '../Images/Markers/Factory.png';
  else if(type == "Wrh" )
    urltype = '../Images/Markers/Warehouse.png';
  else if(type == "Dis" )
    urltype = '../Images/Markers/Distributor.png';
  else if(type == "Sup" )
    urltype = '../Images/Markers/Supplier.png';
  else if(type == "Str" )
    urltype = '../Images/Markers/Store.png';
