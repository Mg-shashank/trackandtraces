...
var https = require("https");
 ...
 class OrderPlaced extends React.Component {
  ...
  response.on('data',(data)=> {		
      ...
      const optimizedData = datas.map(data=>({orderid: data.OrderID.S,orderstatus: data.OrderStatus.S,Product:data.Product.S,Quantity:data.Quantity.S,createdat:data.CreatedAt.S}));
      // const optimizedData = datas.map(data=>({orderid: data.OrderID.S}));
