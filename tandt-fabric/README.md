...
pointing to the Fabric network you created in [Part 1](../tandt-fabric/README.md). AWS CloudFormation 
...
entered when creating the Fabric network in [Part 1](../tandt-fabric/README.md), or can be found 
...
```
cp ~/trackandtrace/tandt-fabric/configtx.yaml ~
vi ~/configtx.yaml
```
